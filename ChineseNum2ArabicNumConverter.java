...
public class ChineseNum2ArabicNumConverter {
	...
	static{
		chineseDigit2AragicDigitMap.put('一', /* => */ 1);
		chineseDigit2AragicDigitMap.put('二', /* => */ 2);
		chineseDigit2AragicDigitMap.put('三', /* => */ 3);
		chineseDigit2AragicDigitMap.put('四', /* => */ 4);
		chineseDigit2AragicDigitMap.put('五', /* => */ 5);
		chineseDigit2AragicDigitMap.put('六', /* => */ 6);
		chineseDigit2AragicDigitMap.put('七', /* => */ 7);
		chineseDigit2AragicDigitMap.put('八', /* => */ 8);
		chineseDigit2AragicDigitMap.put('九', /* => */ 9);
	}
